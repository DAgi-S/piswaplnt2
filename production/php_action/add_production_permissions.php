...
// Function to add production permissions
function addProductionPermissions() {
    global $connect;
    
    // Define production permissions following existing naming convention
    $productionPermissions = [
        'view_production' => 'Can access production module',
        'create_production' => 'Can create production orders',
        'edit_production' => 'Can edit production orders',
        'delete_production' => 'Can delete production orders',
        'manage_production' => 'Can manage production settings'
    ];
    ...
    foreach ($productionPermissions as $permissionName => $description) {
        ...
        if ($result->num_rows == 0) {
            ...
            // Assign permission to role ID 2 (your role)
...
$result = addProductionPermissions();
