...
<div class="modal fade" id="removeCategoriesModal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
        <div class="remove-messages"></div>
        <input type="hidden" id="removeCategoriesId" name="removeCategoriesId">
        <p>Do you really want to remove this category?</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary" id="removeCategoriesBtn">Confirm Remove</button>
      </div>
    </div>
  </div>
</div>
