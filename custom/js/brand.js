...
function removeBrands(brandId = null) {
	if(brandId) {
		console.log('Remove brand triggered for ID:', brandId); // Debug log
		
		// Show confirmation modal
		$('#removeMemberModal').modal('show');
		
		// When user clicks "Save changes" in modal
		$("#removeBrandBtn").off('click').on('click', function() {
			console.log('Save changes clicked for brand removal'); // Debug log
			...
			$.ajax({
				...
				dataType: 'json',
				success: function(response) {
					console.log('Remove brand response:', response); // Debug log
